...
describe('Policy', () => {
    it('wraps', async () => {
        const policy = Policy_1.Policy.wrap(Policy_1.Policy.handleType(MyError1)
            .retry()
            .attempts(3), Policy_1.Policy.handleAll().circuitBreaker(100, new Breaker_1.ConsecutiveBreaker(2)));
    ...
    it('applies Policy.use', async () => {
        ...
        chai_1.expect(await c.double(2)).to.deep.equal({
            n: 4,
            attempt: 2,
        });
    });
