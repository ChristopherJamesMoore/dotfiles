...
describe('RetryPolicy', () => {
    ...
    describe('setting backoffs', () => {
        ...
        it('sets the retry delay', async () => {
            await chai_1.expect(p
                .delay(50)
                .attempts(1)
                .execute(s)).to.eventually.be.rejectedWith(MyErrorA);
    ...
    it('retries all errors', async () => {
        const s = sinon_1.stub()
            ...
            .onSecondCall()
            .returns('ok');
        chai_1.expect(await Policy_1.Policy.handleAll()
            .retry()
            .execute(s)).to.equal('ok');
        chai_1.expect(s).to.have.been.calledTwice;
    });
    it('filters error types', async () => {
        const s = sinon_1.stub()
            ...
            .onSecondCall()
            .throws(new MyErrorB());
        await chai_1.expect(Policy_1.Policy.handleType(MyErrorA)
            .retry()
            .attempts(5)
            .execute(s)).to.eventually.be.rejectedWith(MyErrorB);
        chai_1.expect(s).to.have.been.calledTwice;
    });
